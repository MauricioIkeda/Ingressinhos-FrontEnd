...
class Endpoints {
  ...
  // API Auth
  static String get ingressinhosBaseUrl => 'http://$baseHost:5202'; // verdadeiro http://$baseHost:5202
  static String get authBaseUrl => 'http://$baseHost:5254'; // verdadeiro http://$baseHost:5254
